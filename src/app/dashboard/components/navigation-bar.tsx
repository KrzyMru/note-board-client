    ...
    return (
        <nav className="flex flex-1 flex-row flex-wrap items-end md:flex-col md:flex-nowrap">
            ...
            >
                ...
                />
                <p className={`text-base font-semibold line-clamp-1 [transition:color_350ms] ${currentPage.startsWith("/dashboard/notes") ? "text-gray-900" : "text-gray-300"}`}>Notes</p>
            </button>
            <button
            ...
            >
                <Image 
                    ...
                    className="size-[24px] shrink-0 mr-5"
                />
                <p className={`text-base font-semibold line-clamp-1 [transition:color_350ms] ${currentPage.startsWith("/dashboard/categories") ? "text-gray-900" : "text-gray-300"}`}>Categories</p>
            </button>
            <button 
            ...
            >
                ...
                />
                <p className={`hidden text-base font-semibold line-clamp-1 text-gray-900 md:block`}>Sign out</p>
            </button>
        </nav>
    );
}
